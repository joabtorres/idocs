    ...
    <article class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <section class="modal-content">
            ...
            <article class="modal-body">
                <form method="post" class="needs-validation auth_form" novalidate enctype="multipart/form-data">
                    <?= csrf_input() ?>
                    <div class="ajax_response"><?= flash() ?></div>
                    <div class="form-row">
                        <div class="col-12 mb-3">
                            <label for="inome">Nome: *</label>
                            <input name="fullName" id="inome" class="form-control" required />
                        ...
                        <div class="col-4 mb-3">
                            ...
                            <input type="text" name="email" id="iemail" class="form-control" required />
                            <div class="invalid-feedback"><i class="fa fa-info-circle"></i> Informe o e-mail</div>
                        </div>
                        <div class="col-4 mb-3">
                            <label for="iphone">Telefone: *</label>
                            <input type="text" name="phone" id="iphone" class="form-control" required />
